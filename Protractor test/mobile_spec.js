...
// 	it('',function(){
// 		var entries=element.all(by.repeater("entry in entries"));
// 		entries.get(0).element(by.css('[ng-click="panel.selectTab(2)"]')).click();
// 		browser.sleep(2000);
...
// 	it('',function(){
// 		var entries=element.all(by.repeater("entry in entries"));
// 		entries.get(0).element(by.css('[ng-click="panel.selectTab(3)"]')).click();
// 		browser.sleep(2000);
...
describe("Edit tag",function(){
	it("Edit tag",function(){
		...
		browser.actions().mouseMove(firstTag,{x:400}).mouseDown().mouseMove({x:200}).perform();
		browser.sleep(3000)
...
describe("open child tag",function(){
	it("check all child tag show in tag list",function(){
		var tagList=element.all(by.repeater("tag in filteredTags"));
